...
class MplCanvas(Canvas):
    def __init__(self):
        self.fig = Figure()
        self.ax = self.fig.add_subplot(111, facecolor = "0.3")
        self.fig.set_facecolor("0.3")
        ...
        self.ax.tick_params(which = 'both', colors='white')
        ...
        self.ax2.tick_params(which = 'both', colors='white')
